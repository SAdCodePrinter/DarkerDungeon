...
public class Karaktere {
    ...
    public Karaktere(GamePanel gamePanel) {
        ...
        // Spieler
        kH1 = new KeyHandler(KeyEvent.VK_W, KeyEvent.VK_S, KeyEvent.VK_A, KeyEvent.VK_D, KeyEvent.VK_P, gamePanel);
        kH2 = new KeyHandler(KeyEvent.VK_UP, KeyEvent.VK_DOWN, KeyEvent.VK_LEFT, KeyEvent.VK_RIGHT, 0, gamePanel);

        player1 = new Player(gamePanel, kH1, "/players/player1/");
        player2 = new Player(gamePanel, kH2, "/players/player2/");

        player1.setDefault(1000, 300, 8);
        player2.setDefault(250, 250, 4);
